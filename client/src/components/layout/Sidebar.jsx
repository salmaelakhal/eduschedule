...
const MENU = [
  {
    ...
    items: [
      ...
      { to: '/admin/schedule',  icon: CalendarDays,    label: 'Affectation' },
    ],
  },
];
    ...
    <aside style={{
              ...
              >
                {({ isActive }) => (
                  <>
                    <item.icon
                      size={16}
                      style={{ color: isActive ? 'var(--color-accent)' : 'var(--color-text2)', flexShrink: 0 }}
                    />
                    {item.label}
                  </>
                )}
      ...
      <div style={{
        ...
        <button
          ...
          onMouseEnter={e => e.currentTarget.style.color = 'var(--color-accent3)'}
